...
required_packages <- c("knitr","ggplot2","readxl","tidyverse","genepop","hierfstat","here","mapdata",
                       ...
                       "ade4","remotes","ggtreeExtra","viridis","factoextra","openxlsx","ggrepel","RClone","ggsci","scales","lme4","dplyr")    
...
general_data <- read_excel("Table_S1_data.xlsx")
...
#final_table<- mutate(final_table, Year = as.numeric(Year))
