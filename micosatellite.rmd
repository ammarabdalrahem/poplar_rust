...
npg_colors <- pal_npg("nrc")(8)  # Extract NPG colors, 8 colors for top 8 MLLs later
...
dat1_filtered <- dat1[dat1$MLL %in% 1:8, ]
...
mll_color_mapping <- c(
  ...
  "4" = npg_colors[4],
  "5" = npg_colors[5],
  "6" = "grey",  # Set MLL 6 to grey, it's sexual lineage
  "7" = npg_colors[6],  
  "8" = npg_colors[7]
)
...
mll_color_mapping <- c(
  ...
  "4" = npg_colors[4],
  "5" = npg_colors[5],
  "Other MLLs" = "grey",  # Set MLL 6 to grey, it's sexual lineage
  "7" = npg_colors[6],  
  "8" = npg_colors[7]
)
