...
ggsave("tree_plot2.png", p, width = 17, height = 8, dpi = 600, bg = "transparent")  # Save the plot with desired dimensions
...
par(mai = c(0.5, 0.5, 0.35, 0.2), omi = c(0.25, 0.5, 0, 0),
    mgp = c(2.5, 0.5, 0), family = "Arial",col = "yellow")
...
map("france", fill = FALSE, col = "yellow", xlim = xlim, ylim = ylim, add = TRUE)
final_map <- draw.pie(xyz$x, xyz$y, xyz$z, radius = 0.3, col = transparent_colors)

legend(-4.5, 45, legend = c("Clonal", "Sex"), fill = transparent_colors, bty = "n", cex = 1.5, ncol = 1, text.col = "white")
