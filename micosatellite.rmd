...
required_packages <- c("knitr","ggplot2","readxl","tidyverse","genepop","hierfstat","here","mapdata",
                       "mapplots","data.table","grDevices","colorspace","adegenet","poppr","pegas","ape","ade4","remotes","ggtree","ggtreeExtra","viridis","factoextra")
...
data <- read_excel("SexASex4Ammar+departements.xlsx", 
                  sheet = "Ammar")
...
#choose number of cluster depending on silhouette algorithm combination with our pervoius knpwlage it will be K=2

#fviz_nbclust(genotype_mlp, kmeans, method = "silhouette")
...
##G/N and Fis calculation for Mll for Asex group
